    ...
    <div>
        ...
        <div className='flex  flex-col justify-around h-screen' >
            ...
            <p className="text-center" >
              Don't have an account ? <Link className="text-blue-500" to="/captain-singup">Singup here</Link>
            </p>
          </form>
          <div className=" px-15" >
            ...
            <Link
              to="/user-singup"
            className=' flex items-center justify-center w-full rounded py-2 active:scale-105 mb-3 bg-orange-500' >
        Sign as a user
            </Link>
          </div>
        </div>
